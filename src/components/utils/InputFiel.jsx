...
export function InputFiel ({ register, placeholder, name, onChange, type, errors, labelText, requiredText, xlColSpan = 'xl:col-span-2', patternValue, patternText, disabled, loading }) {
  return (
